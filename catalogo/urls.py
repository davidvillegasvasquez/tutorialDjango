...
#Como VistaDetalleDeLibro.as_view() es una rama que depende del url 'libro', me exige que name sea libro-detail, dónde -detail es reservado por django y libro como minúscula del modelo Libro.
